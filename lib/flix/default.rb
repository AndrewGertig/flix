...
module Flix
  module Default
    ENDPOINT = 'https://api.flix.com' unless defined? ENDPOINT
    ...
    class << self
      ...
      # @note This is configurable in case you want to use HTTP instead of HTTPS or use a Flix-compatible endpoint.
